  ...
  return (
    <div className="flex border items-center justify-between rounded p-1 ">
      <div className="flex justify-between w-full">
        <div className="border-r-2 w-[16%] items-center flex justify-center">
          <Link
        ...
        <div className="border-r-2 w-[16%] items-center flex justify-center">
          <Link
            ...
            className="bg-blue-100 p-1 rounded-3xl"
          >
            <RiContactsBook2Line size={18} color="blue" />
          </Link>
        </div>

        <div className="flex items-center w-[35%] border-r-2">
          <div className="bg-blue-800 rounded-3xl mx-3">
            <TbUsersGroup size={25} color="white" className="p-1" />
          </div>
          <div className="h-[27px]">
            <p className="text-[12px] h-[12px] my-0">Step3/5</p>
        ...
        <Link
          ...
          className="border-r-2 opacity-40 w-[16%] items-center flex justify-center"
        >
          <BsBrightnessAltHigh size={16} />
        </Link>
        <Link
          href={"/membership/contact"}
          className="flex justify-center opacity-40 w-[16%] items-center "
        >
          <PiCrossThin size={16} />
        </Link>
      </div>
